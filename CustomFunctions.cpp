...
void check_carry(char operand = 'A'){
	if(registers[operand]>255){							//to check flags for add,sub........
		flag['c']=1;
...
void check_sign(char operand ='A'){
...
void check_zero(char operand = 'A'){
...
void check_parity(char operand = 'A'){
	int count=0;
...
void check_auxilary(char operand = 'A'){
